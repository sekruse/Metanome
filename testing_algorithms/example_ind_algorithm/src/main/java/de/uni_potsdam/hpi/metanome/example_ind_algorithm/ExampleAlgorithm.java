...
public class ExampleAlgorithm implements InclusionDependencyAlgorithm, TempFileAlgorithm, RelationalInputParameterAlgorithm, StringParameterAlgorithm, FileInputParameterAlgorithm, IntegerParameterAlgorithm {
	...
	public final static String RELATIONAL_IDENTIFIER = "input";
	...
	protected boolean relationalInputSet = false;
	...
	public List<ConfigurationSpecification> getConfigurationRequirements() {
		...
		configurationSpecification.add(new ConfigurationSpecificationRelationalInput(RELATIONAL_IDENTIFIER));
	...
	public void execute() throws AlgorithmExecutionException {
		...
		if ((tableName != null) && fileInputSet && relationalInputSet && (numberOfTables != -1)) {
	...
	public void setRelationalInputConfigurationValue(String identifier, RelationalInputGenerator... values) throws AlgorithmConfigurationException {
		if ((identifier.equals(RELATIONAL_IDENTIFIER)) && (values.length == 1)) {
			relationalInputSet = true;
			System.out.println("Relational input file is not being set on algorithm.");
		} else {
			throw new AlgorithmConfigurationException("Incorrect identifier or value list length.");
		}
	}
