...
public class GwtTestRelationalInputParameter extends GWTTestCase {
	...
	public void testCreateWithFixedNumber() throws AlgorithmConfigurationException {
		//Setup
		int noOfValues = 3;
		ConfigurationSpecificationRelationalInput specification = new ConfigurationSpecificationRelationalInput("relational", noOfValues);

		//Execute
		InputParameterRelationalInputWidget widget = new InputParameterRelationalInputWidget(specification);
	...
	public void testAddInput() throws AlgorithmConfigurationException {
		//Setup
		ConfigurationSpecificationRelationalInput specification = new ConfigurationSpecificationRelationalInput("relational",
